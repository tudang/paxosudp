...
ovs-vsctl add-port br0 ge-1/1/1 vlan_mode=access tag=2 -- set Interface ge-1/1/1 type=pica8
...
ovs-vsctl add-port br0 ge-1/1/6 vlan_mode=access tag=2 -- set Interface ge-1/1/6 type=pica8
ovs-vsctl add-port br0 ge-1/1/7 vlan_mode=access tag=2 -- set Interface ge-1/1/7 type=pica8
ovs-vsctl add-port br0 ge-1/1/8 vlan_mode=access tag=4 -- set Interface ge-1/1/8 type=pica8
ovs-vsctl add-port br0 ge-1/1/9 vlan_mode=access tag=3 -- set Interface ge-1/1/9 type=pica8
ovs-vsctl add-port br0 ge-1/1/20 vlan_mode=trunk trunks=2,4 -- set Interface ge-1/1/20 type=pica8
ovs-vsctl add-port br0 ge-1/1/30 vlan_mode=trunk trunks=2,4 -- set Interface ge-1/1/30 type=pica8
...
ovs-vsctl add-port br0 ge-1/1/45 vlan_mode=trunk trunks=2,3 -- set Interface ge-1/1/45 type=pica8
ovs-ofctl add-group br0 group_id=1,type=all,bucket=output:7,bucket=output:30,bucket=output:31
